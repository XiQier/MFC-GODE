...
def parse_args():
    ...
    #MFC_GODE
    parser.add_argument('--train_t', type=float, default=1.2)
    parser.add_argument('--test_t', type=float, default=0.952)
    parser.add_argument('--n_steps', type=int, default=3)
    parser.add_argument('--test_n_steps', type=int, default=2)
